...
from courseinfo.views import (
    ...
    InstructorCreate, SectionCreate, SemesterCreate, CourseCreate, StudentCreate, RegistrationCreate,
    InstructorUpdate, SectionUpdate, SemesterUpdate, CourseUpdate, StudentUpdate, RegistrationUpdate,
    InstructorDelete, SectionDelete, SemesterDelete, CourseDelete, StudentDelete, RegistrationDelete,
)
urlpatterns = [
    path('instructor/',
